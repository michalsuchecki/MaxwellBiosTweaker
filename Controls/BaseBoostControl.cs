...
namespace MaxwellBiosTweaker.Controls
{
    public class UCBaseBoostControl : UserControl, ComponenteDaTela
    {
        ...
        private Label FE002;
        private Label FE003;
        private ClockSelectorControl FE004;
        private ClockSelectorControl FE005;
        private ClockSelectorControl FE006;
        private Label FE007;
        ...
        private void E00B()
        {
            ...
            this.FE006 = new ClockSelectorControl();
            this.FE005 = new ClockSelectorControl();
            this.FE004 = new ClockSelectorControl();
            this.SuspendLayout();
