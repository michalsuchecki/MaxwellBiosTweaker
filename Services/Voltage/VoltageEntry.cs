...
internal class VoltageEntry : BiosTweakerBase
{
    ...
    public uint PE005
    {
        get
        {
            return BitConverter.ToUInt32(base.buffer, base.offset + 10);
        }
        set
        {
    ...
    private void ME001()
    {
        ...
        Buffer.BlockCopy(numArray, 0, base.buffer, base.offset + num, numArray.Length);
    }
}
